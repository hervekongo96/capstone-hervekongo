...
function Oeuvretypewireframe() {
  ...
  const webData = alldata.filter(item => item.type === 'wireframe');

  if (webData.length === 0) {
    return (
      <div>
        <p>Aucune œuvre de type "wireframe" n'a été trouvée.</p>
      </div>
    );
  }
...
export default Oeuvretypewireframe;
