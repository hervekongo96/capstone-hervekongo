...
const MenuComponent = () => {
  ...
  return (
    <div className="bg-white flex flex-col sm:flex-row justify-between items-center p-4">
        <div className="relative inline-block text-left sm:order-1 sm:flex flex-row">
            <div>
        ...
        <div className="overflow-x-auto flex gap-8 justify-center font-bold text-xl space-x-4 mt-4 sm:mt-0 sm:order-2 sm:flex hidden">
